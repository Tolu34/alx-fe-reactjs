  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4 sm:p-4 md:p-8">
        ...
        p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-xs md:max-wsm w-full ">

        
      <img 
      src="https://via.placeholder.com/150" 
      alt="Profile" 
      className="rounded-full object-cover w-24 h-24 sm:h-24 md:w-36 mb-4"/>
      <h1 className=" font-bold  text-lg sm:text-lg md:text-xl text-blue-700">John Doe</h1>
